...
extern "C" {
	...
	AAPIEXPORT int ECIChangeStateMeteringById(int idmetering, int aState, double Time, double Ciclo, int identity=0);	
	...
	AAPIEXPORT int ECIChangeParametersDelayMeteringVehType(int idsection, double timeSta, double newavg, double newdev, const unsigned short * name);
	AAPIEXPORT int ECIChangeParametersDelayMeteringVehTypeById(int idmetering, double timeSta, double newavg, double newdev, const unsigned short * name);
